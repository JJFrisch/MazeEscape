	...
	switch (theme) {
		...
		case 'forest':
			return {
				strokeColor: '#4ade80',
				bgColor: '#061006',
				cellBgColor: 'rgba(74,222,128,0.02)',
				cellStrokeColor: 'rgba(74,222,128,0.05)',
				startCellColor: 'rgba(74,222,128,0.10)',
				startCellStroke: 'rgba(74,222,128,0.22)',
				exitCellColor: 'rgba(251,191,36,0.12)',
				exitCellStroke: 'rgba(251,191,36,0.24)',
				visitedColor: 'rgba(74,222,128,0.05)',
				wallWidth: 2,
				wallGlowWidth: 2.5,
				wallLineCap: 'round',
				wallLineJoin: 'round',
				...
				playerStroke: 'none',
				playerStrokeWidth: 0,
				playerHaloColor: 'rgba(74,222,128,0.16)',
				playerGlow: true,
				exitDotColor: '#fbbf24',
				exitGlow: false,
